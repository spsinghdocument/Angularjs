...
(function() {
  ...
  sliderDirective = function($timeout) {
    return {
      ...
      template: '<span class="bar"></span><span class="bar selection"></span><span id="UISlidePointer" class="pointer"></span><span class="pointer" style="visibility: hidden;"></span><span class="bubble selection"></span><span ng-bind-html-unsafe="translate({value: floor})" class="bubble limit"></span><span ng-bind-html-unsafe="translate({value: ceiling})" class="bubble limit"></span><span class="bubble"></span><span class="bubble"></span><span class="bubble"></span>',
